...
export const editFileTool: Tool = {
    ...
    usageNotes: {
        whenToUse: "Use to make small, targeted changes to a specific part of an existing file while preserving the rest of its content. If the file does not exist, use the `write_file` tool to create it first.",
